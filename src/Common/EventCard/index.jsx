    ...
    <div className={styles.eventCardWrapper} onClick={onClick}>
      ...
      <div className={styles.cardContent}>
          ...
          <div>
            ...
            <div className="d-flex flex-wrap justify-content-start align-items-start gap-3 mb-4">
              <div className="d-flex flex-wrap gap-2">
                ...
                <div
                  className={`${styles.dateContainer} d-flex align-items-center`}
                >
                  <DynamicIcon
                    name="clock"
                    size={18}
              ...
              >
                <div className={styles.priceContainer}>
                  <h6 className="m-0">Life Member: </h6>
                  <h6>₹ {amount}</h6>
                </div>
          ...
          <div className="d-flex flex-column gap-2">
            {/* <div className={styles.daysLeftBadge}>
              ...
              <span className={styles.daysText}>
                {event.daysLeft !== "Ended" ? "days left" : ""}
              </span>
            </div> */}
            {/* {status && (
              <span
        ...
        <div className={styles.cardBody}>
          ...
          <p className={`${styles.overview} ${expanded ? styles.expanded : ""}`}>{overview}</p>
          {
            overview.split(" ").length > 30 && (
              <span className={styles.readMoreBtn} onClick={() => setExpanded(!expanded)}>
